...
exports.cooksillustratedparserjs = undefined;
...
var cooksillustratedparserjs_cooksillustratedparserjs;

exports.cooksillustratedparserjs = cooksillustratedparserjs_cooksillustratedparserjs = _baseRecipeParser.baserecipeparserjs.extend({
  initialize: function initialize() {
    _baseRecipeParser.baserecipeparserjs.prototype.initialize.apply(this, arguments);
    this.set('dataFile', _path2.default.resolve(__dirname + '/../test/data/cooks-illustrated.js'));
    ...
    this._words = ['chopped', 'cracked', 'finely', 'fresh', 'grated', 'ground', 'hard-cooked', 'minced', 'ripe', 'shredded', 'toasted'];
  },
...
exports.cooksillustratedparserjs = cooksillustratedparserjs_cooksillustratedparserjs;