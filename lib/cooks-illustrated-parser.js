...
cooksillustratedparserjs_cooksillustratedparserjs = baserecipeparser_baserecipeparserjsjs.extend({
  initialize: function() {
    baserecipeparser_baserecipeparserjsjs.prototype.initialize.apply(this, arguments);
    this.set('dataFile', path_nodePath.resolve(__dirname + '/../test/data/cooks-illustrated.js'));
...
export { cooksillustratedparserjs_cooksillustratedparserjs as cooksillustratedparserjs };
