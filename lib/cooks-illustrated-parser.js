...
mod_cooksillustratedparserjs = BaseRecipeParser.extend({
  initialize: function() {
    BaseRecipeParser.prototype.initialize.apply(this, arguments);
    this.set('dataFile', ext_nodePath.resolve(__dirname + '/../test/data/cooks-illustrated.js'));
...
export { mod_cooksillustratedparserjs as cooksillustratedparserjs };
