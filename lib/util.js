...
_.str = _underscore4.default;
_.mixin(_.str.exports());

var strcmp = function strcmp(str1, str2) {
...
var writePlist = function writePlist(callback, obj, output) {
...
var rawtext = function rawtext(elem) {
  var text = '',
      child,
      children;
...
var striptags = function striptags(elem) {
  var text = '',
      child,
      children;
...
var fulltext = function fulltext(elem) {
  var text = '',
      child,
      children;
...
var token = /((?:[^"']|".*?"|'.*?')*?)([(,)]|$)/g;
var splitCSS = function splitCSS(string) {
...
var downloadImage = function downloadImage(src, callback) {
  if (src.indexOf('//') === 0) {
...
var objectLiteral__ = _underscore2.default;
