...
var entities_decodejs = _interopRequireWildcard(_entities);
...
// External libs.
var _ = util._ = _underscore2.default;
...
util.altMeasurementTerms = _underscore2.default.union(_altMeasurementTerms, _underscore2.default.map(_altMeasurementTerms, function (term) {
...
util.saveIngredients = function (items, fileName) {
  ...
  _underscore2.default.each(items, function (item) {
    _underscore2.default.each(item.saveIngredients, function (ingredient) {
...
exports.util = util_util = util;
exports.util = util_util;