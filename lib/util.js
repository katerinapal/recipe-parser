...
util.altMeasurementTerms = ext_underscore__.union(_altMeasurementTerms, ext_underscore__.map(_altMeasurementTerms, function(term) {
...
util.saveIngredients = function(items, fileName) {
  ...
  ext_underscore__.each(items, function(item) {
    ext_underscore__.each(item.saveIngredients, function(ingredient) {
