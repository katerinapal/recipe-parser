...
var addSummary = function addSummary($, obj) {
  ...
  listHelper($, '.entry span[itemprop="description"]', false, function (ele) {
    ...
    if (summary) {
      obj.summaries.push((0, _util3.substituteFraction)(_util3.util.trim(summary)));
    }
  });
};
...
var addProcedure = function addProcedure($, obj) {
  ...
  listHelper($, '.entry span[itemprop="recipeInstructions"]', true, function (procedure) {
    ...
    obj.procedures.push((0, _util3.substituteDegree)((0, _util3.substituteFraction)(_util3.util.trim(procedure.striptags || procedure.innerHTML))));
  });
};
    ...
    if (text) {
      ...
      if (matches && matches.length) {
        ...
        if (matches[3].indexOf(',') > 0) {
          ...
          breakdown.product = (0, _util3.substituteFraction)(_util3.util.trim(matches[1]));
          breakdown.direction = (0, _util3.substituteFraction)(_util3.util.trim(matches[2]));
        } else {
          breakdown.product = (0, _util3.substituteFraction)(_util3.util.trim(matches[3]));
        }
