...
import { goodeatsjs as ge } from "../test/data/good-eats";
...
var CategoryClassifier = ext_Backbone.Model.extend({
  initialize: function() {
  },
...
mod_CategoryClassifier = CategoryClassifier;
export { mod_CategoryClassifier as CategoryClassifier };
