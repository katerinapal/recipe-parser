...
import { _ as utiljs__ } from "./util";
// Nodejs libs.
var _ = utiljs__;
...
var buildStems = function(data) {
  var stemmer = ext_natural_natural.PorterStemmer,
...
var CategoryClassifier = ext_backbone_Backbone.Model.extend({
  initialize: function() {
  },
  guessCategories: function(ingredients) {
    var classifier = new ext_natural_natural.BayesClassifier();
