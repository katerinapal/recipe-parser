...
var CategoryClassifier = Backbone.Model.extend({
  initialize: function() {
  },
...
var exported_CategoryClassifier = CategoryClassifier;
export { exported_CategoryClassifier as CategoryClassifier };
