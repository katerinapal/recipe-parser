...
import { goodeatsjs as testdatagoodeats_goodeatsjsjs } from "../test/data/good-eats";
...
var buildStems = function(data) {
  var stemmer = natural_natural.PorterStemmer,
...
var categoryclassifier_CategoryClassifier;

var CategoryClassifier = backbone_Backbone.Model.extend({
  initialize: function() {
  },
  guessCategories: function(ingredients) {
    var classifier = new natural_natural.BayesClassifier();

    var topHash = buildTopIngredients(testdatagoodeats_goodeatsjsjs);
    ...
    buildClassifierDocuments(testdatagoodeats_goodeatsjsjs, classifier, topHash, topList);
...
categoryclassifier_CategoryClassifier = CategoryClassifier;
export { categoryclassifier_CategoryClassifier as CategoryClassifier };
