...
var constants = macgourmetconstants_constants.constants, classifier = new categoryclassifier_CategoryClassifierjs(), _ = util_utiljs._;
...
var addSummary = function($, obj) {
  ...
  listHelper($, '.hrecipe .content-unit .summary p', function(index, summary) {
    ...
    text = util_utiljs.substituteDegree(util_utiljs.substituteFraction(_.trim(entities_decodejs)));
    log_logjs.ok(text);
