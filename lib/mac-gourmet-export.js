...
exports.default = _backbone2.default.Model.extend({
  ...
  exportRecipe: function exportRecipe(item, source) {
    ...
    _.each(item.procedures, function (procedure) {
      ...
      if (procText) {
        procText = _util2.default.trimMultipleWhiteSpace(procText);
        procObj = {
          VARIATION_ID: -1,
    ...
    (function walker(array, list, isTop) {
      if (_.isArray(array)) {
        ...
        tmp = _util2.default.substituteDegree(_util2.default.substituteFraction(tmp));
