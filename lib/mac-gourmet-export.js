...
exports.macgourmetexportjs = macgourmetexportjs_macgourmetexportjs = _backbone2.default.Model.extend({
  ...
  exportRecipe: function exportRecipe(item, source) {
    ...
    _.each(item.procedures, function (procedure) {
      ...
      if (procText) {
        procText = _util.util.trimMultipleWhiteSpace(procText);
        procObj = {
          VARIATION_ID: -1,
    ...
    (function walker(array, list, isTop) {
      if (_.isArray(array)) {
        ...
        tmp = _util.util.substituteDegree(_util.util.substituteFraction(tmp));
...
exports.macgourmetexportjs = macgourmetexportjs_macgourmetexportjs;