...
var seriouseatsparserjs = exports = _baseRecipeParser.baserecipeparserjs.extend({
  ...
  postProcessSplitOnAnd: function postProcessSplitOnAnd(descriptions, callback) {
    ...
    if (descriptions.length > 2) {
      ...
      if (util.regexIndexOf(descriptions[1], /^yolks\s+separated$/, 0) >= 0 && util.regexIndexOf(descriptions[2], /^pressed.*$/, 0) >= 0) {
...
exports.seriouseatsparserjs = seriouseatsparserjs;
