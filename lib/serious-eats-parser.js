...
exports.seriouseatsparserjs = mod_seriouseatsparserjs = _baseRecipeParser.baserecipeparserjs.extend({
  ...
  adjustQtyDescriptionsDirections: function adjustQtyDescriptionsDirections(args, callback) {
    ...
    var retval = _.map(_.zip(descriptions, directions, quantities, measurementObjs), function (tuple) {
      ...
      if (zipDesc.toLowerCase() === 'vegetable cooking spray') {
        _log.logjs.warn('Vegetable Cooking Spray amongst ingredients');
      }
...
var mod_seriouseatsparserjs;
exports.seriouseatsparserjs = mod_seriouseatsparserjs;