...
exports.FoodNetworkRecipeParser = undefined;
...
var foodnetworkparser_FoodNetworkRecipeParser;

var FoodNetworkRecipeParser = _baseRecipeParser.baserecipeparserjs.extend({
  initialize: function initialize() {
    _baseRecipeParser.baserecipeparserjs.prototype.initialize.apply(this, arguments);
    this.set('dataFile', _path2.default.resolve(__dirname + '/../test/data/food-network.js'));
  ...
  postProcessSplitOnAnd: function postProcessSplitOnAnd(descriptions, callback) {
    ...
    if (descriptions.length > 2) {
      ...
      if (_util3.util.regexIndexOf(descriptions[1], /^sliced\s+thick$/, 0) >= 0) {
        retval = [descriptions.join(' and ')];
      }
    }
...
exports.FoodNetworkRecipeParser = foodnetworkparser_FoodNetworkRecipeParser = FoodNetworkRecipeParser;
exports.FoodNetworkRecipeParser = foodnetworkparser_FoodNetworkRecipeParser;