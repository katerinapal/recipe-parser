...
var FoodNetworkRecipeParser = _baseRecipeParser2.default.extend({
  ...
  postProcessSplitOnAnd: function postProcessSplitOnAnd(descriptions, callback) {
    ...
    if (descriptions.length > 2) {
      ...
      if (_util4.default.regexIndexOf(descriptions[1], /^sliced\s+thick$/, 0) >= 0) {
        retval = [descriptions.join(' and ')];
      }
    }
...
exports.default = FoodNetworkRecipeParser;
