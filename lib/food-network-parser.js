...
var FoodNetworkRecipeParser = BaseRecipeParser.extend({
  initialize: function() {
    BaseRecipeParser.prototype.initialize.apply(this, arguments);
    this.set('dataFile', ext_nodePath.resolve(__dirname + '/../test/data/food-network.js'));
...
mod_FoodNetworkRecipeParser = FoodNetworkRecipeParser;
export { mod_FoodNetworkRecipeParser as FoodNetworkRecipeParser };
