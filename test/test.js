...
var Parsers = [_cooksIllustratedParser.libcooksillustratedparser_obj, _seriousEatsParser.libseriouseatsparser_obj],
    parsers = [new _cooksIllustratedParser.libcooksillustratedparser_obj[0](), new _cooksIllustratedParser.libcooksillustratedparser_obj[1]()],
    ingredientSets = [_cooksIllustrated.datacooksillustrated_obj, _seriousEats.dataseriouseats_obj];
...
describe('recipe instructions parser', function () {
  it('should parse quantity', function () {
    ...
    _.each(_.zip(_cooksIllustrated.datacooksillustrated_obj, parsers), function (tuple) {
      ingredients = tuple[0];
      parser = tuple[1];
